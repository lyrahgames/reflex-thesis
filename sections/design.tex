...
\label{sub:smoothing_of_surface_mesh_curves}
  ...
  But \textcite{lawonn2014} derive their equation by using a different strategy with an non-oriented geodesic curvature which leads to an alternative formulation that could lead to numerical instabilities.
  The derivation of the above primitive has been carried out by myself to provide a single formulation for all values of the oriented discrete geodesic curvature that is able to handle the $κ=0$ singularity.
