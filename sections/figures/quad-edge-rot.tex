...
\definecolor{background}{rgb}{0.7,0.7,0.7}
\definecolor{accent}{rgb}{0.0,0.5,0.8}


\begin{document}
\begin{tikzpicture}[
  line/.style = {thin, color=background},
  ...
  \tkzDefPoint(0.0,0.5){m}
  \tkzDefPoint(0.2,0.52){r}
  \tkzDefPoint(-0.2,0.48){l}
  \tkzDefPoint(-0.02,0.7){t}
  \tkzDefPoint(0.02,0.3){b}
  ...
  %\tkzDrawPoints[face,background](f2,f3)

  \tkzDrawSegments[-{Stealth[left,scale=0.8]}](v1a,v0a v0b,v1b)
  \tkzDrawSegments[-{Stealth[left,scale=0.8]}](f1a,f0a f0b,f1b)

  %\tkzDrawSegments[-{Stealth[left]},color=background](v0,v2 v1,v3)
  %\tkzDrawSegments[-{Stealth[left]},color=background](f0,f2 f1,f3)

  \tkzDrawArc[color=accent,->](m,t)(l)
  \tkzDrawArc[color=accent,->](m,l)(b)
  \tkzDrawArc[color=accent,->](m,b)(r)
  \tkzDrawArc[color=accent,->](m,r)(t)
